...
void CloudViewer::initial() {
  ...
  // 输出窗口
  consoleLog("Software start", "CloudViewer", "Welcome to use", "By Wcgood");

  // 设置背景颜色为
  viewer->setBackgroundColor(125 / 255.0, 100 / 255.0, 200 / 255.0);
...
void CloudViewer::about() {
  ...
  aboutwin->show();
  consoleLog("About", "Show me the money", "story of idle", "You are happy, so I am happy");
}

// 帮助
void CloudViewer::help() {
  QDesktopServices::openUrl(QUrl(QLatin1String("http://www.csrd.cn")));
  consoleLog("Help", "If ask then you lose", "Think for yourself. Wcgood is very busy", "");
}
